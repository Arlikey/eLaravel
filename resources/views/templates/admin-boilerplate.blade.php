...
<body class="d-flex flex-col" data-bs-theme="dark">

    <header class="d-flex border-end">
        <nav class="d-flex flex-fill">
            <div class="container-fluid d-flex flex-row align-items-center justify-content-between py-1">
                ...
                <div class="d-flex flex-row align-items-center">
                    <ul class="navbar-nav flex flex-row mb-2 mb-lg-0 text-center gap-4">
                        <li class="nav-item">
                            <a class="d-flex flex-row align-items-center" aria-current="page"
                ...
                <ul class="navbar-nav flex flex-row gap-4">
                    <li class="nav-item">
